...
<!-- For local testing, the video below works when viewed through a web server -->
<video src="WEBSITE_MTPE BANK_Sản_phẩm_học_viên_ngành_Software_Engineering _ VTC_Academy.mp4" controls>
   Your browser does not support the video tag. Watch the MTPE_BANK Introduction Video here: https://www.youtube.com/watch?v=3zBvXEDJb-w
</video>
